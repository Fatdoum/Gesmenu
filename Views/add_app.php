...
<?php
     include_once('../controllers/db_connect.php');
           $query = $pdo->query("SELECT ID,Nom FROM `session` ");
                   ...
                   <div class="row">
                      <div class="col-3"> 
                          ...
                          <div class="col-3">
                                      ...
                                      <button type="reset" class="btn btn-primary btn-block bg-secondary" style="width: 150px;">Annuler</button>
                                      </div>
                          </div>
          
                      <div class="col-3"> 
                                  <div class="col-sm-6 text-hide">
                                  <button type="sumit" class="btn btn-danger btn-block" style="width: 150px; ">Valider</button>
                                  </div>
                      </div>
